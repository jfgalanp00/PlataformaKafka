...
for m in consumer:
    ...
    if contador<=60: 
        ...
        if ficheroCreado==False:
            ...
            fecha_actual_con_hora = time.strftime("%Y-%m-%d %H-%M humedad", fecha_actual)
        ...
        hdfs_client.write(f"/Pro_IOT/145/humedad/{nom_fichero}", nom_fichero)
