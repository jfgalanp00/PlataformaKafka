...
for m in consumer:
    ...
    luminosidad = ''.join(valor_sucio)

    registro=f'{fecha};{luminosidad}'
    print(registro)
    ...
    if contador<=60: 
        ...
        if ficheroCreado==False:
            ...
            fecha_actual_con_hora = time.strftime("%Y-%m-%d %H-%M luminosidad", fecha_actual)
        ...
        hdfs_client.write(f"/Pro_IOT/145/luminosidad/{nom_fichero}", nom_fichero)
